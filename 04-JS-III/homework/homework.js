...
function mesesDelAño(array) {
  ...
  for (var i = 0; i < array.length; i++) {
    switch (array[i]) {
      case 'Enero': arrayfinal.push('Enero');
        Enero++
        break;
      case 'Marzo': arrayfinal.push('Marzo');
        Marzo++
        break
      case 'Noviembre': arrayfinal.push('Noviembre');
        Noviembre++
        break;
      default:
    }
